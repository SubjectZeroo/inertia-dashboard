                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Editar Usuario</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="col-span-full xl:col-auto">
                <div
                    ...
                    <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" :src="form.profile_photo_url"
                            :alt="form.name" />
                        <div>
            ...
            <div class="col-span-2">
                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="userRole in user.data.roles" :key="userRole.id">
                                ...
                                <TableDataCell>
                                    <a @click="confirmRoleToRemove(userRole)" id="revokePermissionButton" tabindex="-1"
                ...
                <div
                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="userPermission in user.data.permissions" :key="userPermission.id">
                                <TableDataCell class="flex items-center">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">
                                        {{ userPermission.name }}
                                    </div>
                                ...
                                <TableDataCell>
                                    <a @click="confirmPermissionToRevoke(userPermission)" id="revokePermissionButton"
