...
<template>
  <AppLayout title="Crear Vehiculo">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Vehiculo</h2>
    </template>
        ...
        >
          ...
          <form @submit.prevent="submit">
            <div class="grid grid-cols-6 gap-6">
              <Field label="Seleccionar Cliente" :error="form.errors.customers">
                <VueMultiselect
              ...
              <Field label="Seleccionar Modelo" :error="form.errors.vehicle_models">
                <VueMultiselect
                  v-model="form.vehicle_models"
                  :options="vehicle_models.data"
                  :close-on-select="true"
              ...
              <Field label="Seleccionar Marca" :error="form.errors.vehicle_brands">
                <VueMultiselect
                  v-model="form.vehicle_brands"
                  :options="vehicle_brands.data"
                  :close-on-select="true"
