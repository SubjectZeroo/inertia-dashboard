            ...
            <div class="w-full mb-1">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                        aria-current="page">Vehiculos</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="sm:flex">
                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <Link id="createProductButton" href="/vehicles/create"
                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="vehicle in vehicles.data" :key="vehicle.id">
                                ...
                                <TableDataCell>
                                    <Link id="updateVehicleButton" :href="`/vehicles/${vehicle.id}/edit`" tabindex="-1"
                                        data-drawer-target="drawer-update-vehicle-default"
                                        data-drawer-show="drawer-update-vehicle-default"
                                        aria-controls="drawer-update-vehicle-default" data-drawer-placement="right"
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    <PencilSquareIcon class="w-4 h-4 mr-2" />
                                    Actualizar
                                    </Link>
                                    <a @click="confirmVehicleDeletion(vehicle)" id="deleteVehicleButton" tabindex="-1"
                                        data-drawer-target="drawer-delete-vehicle-default"
                                        data-drawer-show="drawer-delete-vehicle-default"
                                        aria-controls="drawer-delete-vehicle-default" data-drawer-placement="right"
