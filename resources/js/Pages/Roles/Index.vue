...
<template>
  <AppLayout title="Roles">
              ...
              <TableRow v-for="role in roles.data" :key="role.id">
                ...
                <TableDataCell>
                  ...
                  <a
                    ...
                    id="deleteRoleButton"
                    tabindex="-1"
                    data-drawer-target="drawer-delete-role-default"
                    data-drawer-show="drawer-delete-role-default"
                    aria-controls="drawer-delete-role-default"
                    data-drawer-placement="right"
    ...
    <DialogConfirmation :show="confirmingRoleDeletion" @close="closeModal">
      ...
      <template #content> ¿Estás seguro de que quieres eliminar este Rol? </template>
