        ...
        >
          ...
          <form @submit.prevent="submit">
            <div class="grid grid-cols-6 gap-6">
              ...
              <Field label="Seleccionar Unidad" :error="form.errors.units">
                <VueMultiselect
                  v-model="form.units"
                  :options="units.data"
              ...
              <Field label="Seleccionar Marca" :error="form.errors.item_brands">
                <VueMultiselect
                  v-model="form.item_brands"
                  :options="item_brands.data"
                  :close-on-select="true"
              ...
              <Field label="Seleccionar Categoria" :error="form.errors.item_categories">
                <VueMultiselect
                  v-model="form.item_categories"
                  :options="item_categories.data"
                  :close-on-select="true"
