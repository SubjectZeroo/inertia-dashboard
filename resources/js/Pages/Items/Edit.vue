...
onMounted(() => {
    form.unit_id = props.item?.data.unit;
    form.item_category_id = props.item?.data.item_category;
    form.item_brand_id = props.item?.data.item_brand;
});
watch(
    () => props.item,
    () => (form.unit_id = props.item?.data.unit),
...
const submit = () => {
    form
        ...
        .put(
            route("items.update", props.item.data.id)
        );
};
</script>

<template>
    <AppLayout title="Editar Articulo">
        <template #header>
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Editar Articulo</span>
                            </div>
                        </li>
                    </ol>
                </nav>
