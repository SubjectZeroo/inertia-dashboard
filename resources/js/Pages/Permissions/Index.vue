...
watch(
    () => formSearch.value,
    throttle(function () {
        router.get("/permissions", pickBy(formSearch.value), { preserveState: true });
    }, 150),
    {
        deep: true,
    }
...
const permissionADelete = ref("");
const form = useForm({});
const confirmPermissionDeletion = (permission) => {
    confirmingPermissionDeletion.value = true;
    permissionADelete.value = permission.id;
};

const deletePermission = () => {
    form.delete(route("permissions.destroy", permissionADelete.value), {
        preserveScroll: true,
            ...
            <div class="w-full mb-1">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                        aria-current="page">Permisos</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="sm:flex">
                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <Link id="createPermissionButton" href="/permissions/create"
                    ...
                    <Table>
                        ...
                        <template #default>
                            <TableRow v-for="permission in permissions.data" :key="permission.id">
                                ...
                                <TableDataCell>
                                    <Link id="updatePermissionButton" :href="`/permissions/${permission.id}/edit`"
                                        tabindex="-1" data-drawer-target="drawer-update-permission-default"
                                        data-drawer-show="drawer-update-permission-default"
                                        aria-controls="drawer-update-permission-default" data-drawer-placement="right"
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    <PencilSquareIcon class="w-4 h-4 mr-2" />
                                    Actualizar
                                    </Link>
                                    <a @click="confirmPermissionDeletion(permission)" id="deletePermissionButton"
